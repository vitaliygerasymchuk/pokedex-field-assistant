...
Also, due to the luck of time - i didn't cover anything with unit/ui tests. But this is easy doable, because core data layers are interfaced and can be mocked. Also i tried to keep the ui in small elements.
